// 1. Find the toggle button using its text content or tag if it doesn't have an ID
const darkModeToggle = document.querySelector('button') || document.querySelector('.toggle-btn');
